function Selection_sort() {
    ...
    for (var i = 0; i < array_size - 1; i++) {
        div_update(divs[i], div_sizes[i], "red"); //Color update // current comparing value

        index_min = i; // 2

        for (var j = i + 1; j < array_size; j++) {
            // i = 0, j = 3
            div_update(divs[j], div_sizes[j], "yellow"); //Color update // second value which is being compared to
